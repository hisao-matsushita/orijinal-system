...
require '../config/validation_account.php';  
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // バリデーション実行
    performValidation($errors, $pdo, $patterns);
    ...
    INSERT INTO accounts (
        ...
        account_tel1, account_tel2,
        account_license_expiration_date,
        ...
        account_employment_date, account_appointment_date,    
        account_retirement_date, registration_date ' . $password_sql . ')
    VALUES (
        :account_no, :account_salesoffice, :account_kana01, :account_kana02, :account_name01, :account_name02,
        :account_birthday, :account_jenda, :account_bloodtype,       
        :account_zipcord, :account_pref, :account_address01, :account_address02, :account_address03,
        ...
        :account_department, :account_workclass, :account_classification, :account_enrollment,  
        :account_employment_date, :account_appointment_date,    
        :account_retirement_date, NOW() ' . $password_placeholder . ')';
        ...
        $stmt->bindValue(':account_address03', empty($_POST['account_address03']) ? null : $_POST['account_address03'], PDO::PARAM_STR);
        ...
        $stmt->bindValue(':account_guarentor_kana01', empty($_POST['account_guarentor_kana01']) ? null : $_POST['account_guarentor_kana01'], PDO::PARAM_STR);
        $stmt->bindValue(':account_guarentor_kana02', empty($_POST['account_guarentor_kana02']) ? null : $_POST['account_guarentor_kana02'], PDO::PARAM_STR);
        $stmt->bindValue(':account_guarentor_name01', empty($_POST['account_guarentor_name01']) ? null : $_POST['account_guarentor_name01'], PDO::PARAM_STR);
        $stmt->bindValue(':account_guarentor_name02', empty($_POST['account_guarentor_name02']) ? null : $_POST['account_guarentor_name02'], PDO::PARAM_STR);
        $stmt->bindValue(':account_relationship', empty($_POST['account_relationship']) ? null : $_POST['account_relationship'], PDO::PARAM_STR);
        $stmt->bindValue(':account_guarentor_zipcode', $account_guarentor_zipcode, PDO::PARAM_STR);
        $stmt->bindValue(':account_guarentor_pref', empty($_POST['account_guarentor_pref']) ? null : $_POST['account_guarentor_pref'], PDO::PARAM_STR);
        $stmt->bindValue(':account_guarentor_address01', empty($_POST['account_guarentor_address01']) ? null : $_POST['account_guarentor_address01'], PDO::PARAM_STR);
        $stmt->bindValue(':account_guarentor_address02', empty($_POST['account_guarentor_address02']) ? null : $_POST['account_guarentor_address02'], PDO::PARAM_STR);
        $stmt->bindValue(':account_guarentor_address03', empty($_POST['account_guarentor_address03']) ? null : $_POST['account_guarentor_address03'], PDO::PARAM_STR);
        ...
        $stmt->bindValue(':account_enrollment', empty($_POST['account_enrollment']) ? null : $_POST['account_enrollment'], PDO::PARAM_INT);
