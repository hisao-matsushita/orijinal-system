...
// 車両管理用データベース設定
$dsnVehicles = 'mysql:dbname=company_management_system;host=localhost;charset=utf8mb4';
$userVehicles = 'root';
$passwordVehicles = '';

// アカウント管理用データベース設定
// $dsnAccount = 'mysql:dbname=tatsumi-taxi_management_db;host=mysql623.db.sakura.ne.jp;charset=utf8mb4';
// $userAccount = 'tatsumi-taxi';
// $passwordAccount = 'h-03271303';

// 車両管理用データベース設定
// $dsnVehicles = 'mysql:dbname=tatsumi-taxi_management_db;host=mysql623.db.sakura.ne.jp;charset=utf8mb4';
// $userVehicles = 'tatsumi-taxi';
// $passwordVehicles = 'h-03271303';
...
// 車両管理用のPDOインスタンス
$pdoVehicles = getPdoInstance($dsnVehicles, $userVehicles, $passwordVehicles);
